...
CREATE TABLE `departments` (
	...
	`department_name` VARCHAR ( 3 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
...
) ENGINE = INNODB AUTO_INCREMENT = 271 CHARACTER 
SET = gb2312 COLLATE = gb2312_chinese_ci ROW_FORMAT = Compact;-- ----------------------------
...
CREATE TABLE `employees` (
	...
	`first_name` VARCHAR ( 20 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`last_name` VARCHAR ( 25 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`email` VARCHAR ( 25 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`phone_number` VARCHAR ( 20 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`job_id` VARCHAR ( 10 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
...
) ENGINE = INNODB AUTO_INCREMENT = 207 CHARACTER 
SET = gb2312 COLLATE = gb2312_chinese_ci ROW_FORMAT = Compact;-- ----------------------------
...
CREATE TABLE `job_grades` (
	`grade_level` VARCHAR ( 3 ) CHARACTER 
...
CREATE TABLE `jobs` (
	`job_id` VARCHAR ( 10 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NOT NULL,
	`job_title` VARCHAR ( 35 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
...
CREATE TABLE `locations` (
	...
	`street_address` VARCHAR ( 40 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`postal_code` VARCHAR ( 12 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`city` VARCHAR ( 30 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`state_province` VARCHAR ( 25 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	`country_id` VARCHAR ( 2 ) CHARACTER 
	SET gb2312 COLLATE gb2312_chinese_ci NULL DEFAULT NULL,
	PRIMARY KEY ( `location_id` ) USING BTREE 
) ENGINE = INNODB AUTO_INCREMENT = 3201 CHARACTER 
SET = gb2312 COLLATE = gb2312_chinese_ci ROW_FORMAT = Compact;-- ----------------------------
