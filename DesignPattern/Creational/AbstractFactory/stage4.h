#ifndef CREATIONAL_ABSTRACTFACTORY_STAGE4_H_
#define CREATIONAL_ABSTRACTFACTORY_STAGE4_H_
...
class WoodenOrnament : public Ornament {
public:
    WoodenOrnament(Room*);
};

class StoneOrnament : public Ornament {
public:
    StoneOrnament(Room*);
};

class IronOrnament : public Ornament {
public:
    IronOrnament(Room*);
};

class CrystalOrnament : public Ornament {
public:
    CrystalOrnament(Room*);
};
